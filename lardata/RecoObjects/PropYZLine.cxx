...
namespace trkf {
  ...
  PropYZLine::PropYZLine(double tcut, bool doDedx)
    : Propagator(tcut,
                 doDedx,
                 (tcut >= 0. ? std::shared_ptr<const Interactor>(new InteractGeneral(tcut)) :
  ...
  bool
  PropYZLine::transformYZLine(double phi1,
                              double phi2,
                              TrackVector& vec,
  ...
  bool
  PropYZLine::transformYZPlane(double phi1,
                               double phi2,
                               TrackVector& vec,
                               Surface::TrackDirection& dir,
                               TrackMatrix* prop_matrix) const
  ...
  bool
  PropYZLine::transformXYZPlane(double theta1,
                                double phi1,
                                double phi2,
                                TrackVector& vec,
                                Surface::TrackDirection& dir,
