...
namespace dataprov{
  ...
  class IDetectorClocks {

  public:
    IDetectorClocks(const IDetectorClocks &) = delete;
    IDetectorClocks(IDetectorClocks &&) = delete;
    IDetectorClocks& operator = (const IDetectorClocks &) = delete;
    IDetectorClocks& operator = (IDetectorClocks &&) = delete;
    virtual ~IDetectorClocks() = default;
