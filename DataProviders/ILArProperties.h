...
// 
////////////////////////////////////////////////////////////////////////
#ifndef DATAPROV_ILARPROPERTIES_H
#define DATAPROV_ILARPROPERTIES_H


///General LArSoft Utilities
namespace dataprov{
  
  class ILArProperties {
    public:

      ILArProperties(const ILArProperties &) = delete;
      ILArProperties(ILArProperties &&) = delete;
      ILArProperties& operator = (const ILArProperties &) = delete;
      ILArProperties& operator = (ILArProperties &&) = delete;
      virtual ~ILArProperties() = default;
