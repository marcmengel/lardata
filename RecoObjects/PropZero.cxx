...
namespace trkf {
					...
					TrackMatrix* prop_matrix) const
  {
    ...
    if(prop_matrix != 0) {
      ...
      double dr2deta1 = dr2ddu2*ddu2deta1 + dr2ddv2*ddv2deta1 + dr2ddw2*ddw2deta1;
      ...
      double dsdeta1 = dsddu2*ddu2deta1 + dsddv2*ddv2deta1 + dsddw2*ddw2deta1;
					  ...
					  TrackMatrix* prop_matrix) const
  {
    ...
    double v2 =                 (y01-y02)*rvy + (z01-z02)*rvz          + v1*rvv + w1*rvw;
					 ...
					 TrackMatrix* prop_matrix) const
  {
    ...
    if(prop_matrix != 0) {
      ...
      double dr2dv1 = dr2dw2*dw2dv1;
      double dr2ddudw1 = dr2ddu2*ddu2ddudw1 + dr2ddv2*ddv2ddudw1 + dr2ddw2*ddw2ddudw1;
      double dr2ddvdw1 = dr2ddu2*ddu2ddvdw1 + dr2ddv2*ddv2ddvdw1 + dr2ddw2*ddw2ddvdw1;
      ...
      double dsdu1 = dsdu2;
      double dsdv1 = dsdw2*dw2dv1;
      double dsddudw1 = dsddu2*ddu2ddudw1 + dsddv2*ddv2ddudw1 + dsddw2*ddw2ddudw1;
      double dsddvdw1 = dsddu2*ddu2ddvdw1 + dsddv2*ddv2ddvdw1 + dsddw2*ddw2ddvdw1;

      // Calculate correction to v parameter partials wrt initial t.p. due to path length.

      double dv2du1 = dv2*dsdu1;
      dv2dv1 += dv2*dsdv1;
      double dv2ddudw1 = dv2*dsddudw1;
      double dv2ddvdw1 = dv2*dsddvdw1;
